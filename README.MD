...
The app is configured for Netlify (TanStack Start + Convex). See **[docs/NETLIFY_DEPLOY.md](docs/NETLIFY_DEPLOY.md)** for build settings, `CONVEX_DEPLOY_KEY`, and optional deploy previews.
